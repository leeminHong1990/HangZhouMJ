...
var GameConfigUI = UIBase.extend({
	...
	change_language:function () {
        var sel_func = function (i) {
            cc.sys.localStorage.setItem("VOICE_LANGUAGE", i === 0 ? "standard" : "local");
        };


        if (cc.sys.localStorage.getItem("VOICE_LANGUAGE") === null) {
            cc.sys.localStorage.setItem("VOICE_LANGUAGE", "standard");
        }
        var sel_index = cc.sys.localStorage.getItem("VOICE_LANGUAGE") ===  "standard" ? 0 : 1;
