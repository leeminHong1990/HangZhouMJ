...
var ResultUI = UIBase.extend({
		...
		this.show(function(){
            ...
            if(!((cc.sys.os == cc.sys.OS_ANDROID && cc.sys.isNative) || (cc.sys.os == cc.sys.OS_IOS && cc.sys.isNative) || switches.TEST_OPTION)) {
                ...
                if(clubId > 0){
                    ...
                    title = '房间号【' + curGameRoom.roomID.toString() + '】';
                }
    ...
    update_player_info: function (panle_idx, serverSitNum, finalPlayerInfo, win_idx, curGameRoom) {
        ...
        cur_player_info_panel.getChildByName("draw_win_label").setString(finalPlayerInfo["draw_win_times"]);
        cur_player_info_panel.getChildByName("bao_tou_win_label").setString(finalPlayerInfo["bao_tou_win_times"]);
        cur_player_info_panel.getChildByName("discard_king_win_label").setString(finalPlayerInfo["king_discard_win_times"]);
        cur_player_info_panel.getChildByName("draw_king_label").setString(finalPlayerInfo["draw_king_times"]);
