var PlaybackGameRoomSceneUIManager = UIManagerBase.extend({
    onCreate: function () {
        var game_room_ui_type = cc.sys.localStorage.getItem("GAME_ROOM_UI");
        ...
        this.roomLayoutMgr.registerRoomObserver("update_playback_operation_panel");
        this.roomLayoutMgr.registerRoomObserver("throwTheDice");
    },
