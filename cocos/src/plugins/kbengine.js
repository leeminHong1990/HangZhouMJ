...
KBEngine.KBEngineApp = function(kbengineArgs)
{
	...
	{  
		...
		KBEngine.app.resetSocket();
		KBEngine.Event.fire("onConnectionState", false);
		h1global.globalUIMgr.info_ui.show_by_info("连接失败，请检查网络！", cc.size(600, 400), function(){if((cc.sys.os == cc.sys.OS_ANDROID && cc.sys.isNative) || (cc.sys.os == cc.sys.OS_IOS && cc.sys.isNative)){h1global.runScene(new LoginScene());}else{window.location.href = switches.h5entrylink;}})
	}
	...
	this.onerror_after_onopen = function(evt)
	{
		...
		h1global.globalUIMgr.info_ui.show_by_info("连接错误，请重新登录游戏！", cc.size(600, 400), function(){if((cc.sys.os == cc.sys.OS_ANDROID && cc.sys.isNative) || (cc.sys.os == cc.sys.OS_IOS && cc.sys.isNative)){h1global.runScene(new LoginScene());}else{window.location.href = switches.h5entrylink;}})
	}
	...
	this.close = function() {
		...
		KBEngine.app.reset();
		h1global.globalUIMgr.info_ui.show_by_info("连接已断开，请重新登录游戏！", cc.size(600, 400), function(){if((cc.sys.os == cc.sys.OS_ANDROID && cc.sys.isNative) || (cc.sys.os == cc.sys.OS_IOS && cc.sys.isNative)){h1global.runScene(new LoginScene());}else{window.location.href = switches.h5entrylink;}})
	}
	...
	*/
	...
	this.Client_onKicked = function(failedcode)
	{
		...
		h1global.globalUIMgr.info_ui.show_by_info("与服务器断开连接，请稍后重新登录游戏！", cc.size(600, 400), function(){if((cc.sys.os == cc.sys.OS_ANDROID && cc.sys.isNative) || (cc.sys.os == cc.sys.OS_IOS && cc.sys.isNative)){h1global.runScene(new LoginScene());}else{window.location.href = switches.h5entrylink;}})
	}
