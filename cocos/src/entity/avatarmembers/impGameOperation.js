...
var impGameOperation = impCommunicate.extend({
	...
	startGame : function(dealerIdx, tileList, wreathsList, kingTiles, prevailing_wind, playerWindList, diceList, swap_list, cur_dealer_mul){
		cc.log("startGame")
		cc.log(dealerIdx, tileList, wreathsList, kingTiles, prevailing_wind, playerWindList, diceList, swap_list, cur_dealer_mul);
		var self = this;
		if(!this.curGameRoom){
			return;
		}
        ...
        if (this.serverSitNum == dealerIdx) {
			...
			cutil.tileSort(this.curGameRoom.handTilesList[this.serverSitNum], kingTiles);
	...
	postMultiOperation : function(idx_list, aid_list, tile_list){
		...
		// } else {
		cc.audioEngine.playEffect(voice_root + "female/sound_woman_win.mp3");
		// }
	},
	...
	postOperation : function(serverSitNum, aid, tileList){
		...
		if(aid == const_val.OP_PASS){
			...
			if(this.curGameRoom.kingTiles.indexOf(tileList[0]) >= 0){
                if(this.curGameRoom.playerInfoList[serverSitNum]["sex"] == 1){
                    cc.audioEngine.playEffect(voice_root + "male/sound_man_piao.mp3");
                } else {
                    cc.audioEngine.playEffect(voice_root + "female/sound_woman_piao.mp3");
                }
			} else {
                if(this.curGameRoom.playerInfoList[serverSitNum]["sex"] == 1){
                    cc.audioEngine.playEffect(voice_root + "male/sound_man_" + tileList[0].toString() + ".mp3");
                } else {
                    cc.audioEngine.playEffect(voice_root + "female/sound_woman_" + tileList[0].toString() + ".mp3");
                }
			}
			...
			if(this.curGameRoom.playerInfoList[serverSitNum]["sex"] == 1){
				cc.audioEngine.playEffect(voice_root + "male/sound_man_chow.mp3");
			} else {
				cc.audioEngine.playEffect(voice_root + "female/sound_woman_chow.mp3");
			}
			...
			if(this.curGameRoom.playerInfoList[serverSitNum]["sex"] == 1){
				cc.audioEngine.playEffect(voice_root + "male/sound_man_pong.mp3");
			} else {
				cc.audioEngine.playEffect(voice_root + "female/sound_woman_pong.mp3");
			}
			...
			if(this.curGameRoom.playerInfoList[serverSitNum]["sex"] == 1){
				cc.audioEngine.playEffect(voice_root + "male/sound_man_kong.mp3");
			} else {
				cc.audioEngine.playEffect(voice_root + "female/sound_woman_kong.mp3");
			}
			...
			// if(this.curGameRoom.playerInfoList[serverSitNum]["sex"] == 1){
			// 	cc.audioEngine.playEffect(voice_root + "male/sound_man_draw_win.mp3");
			// } else {
			// 	cc.audioEngine.playEffect(voice_root + "female/sound_woman_draw_win.mp3");
			// }
            ...
            // if(this.curGameRoom.playerInfoList[serverSitNum]["sex"] == 1){
            //     cc.audioEngine.playEffect(voice_root + "male/sound_man_win.mp3");
            // } else {
            //     cc.audioEngine.playEffect(voice_root + "female/sound_woman_win.mp3");
            // }
			...
			if(this.curGameRoom.playerInfoList[serverSitNum]["sex"] == 1){
				cc.audioEngine.playEffect(voice_root + "male/sound_man_buhua.mp3");
			} else {
				cc.audioEngine.playEffect(voice_root + "female/sound_woman_buhua.mp3");
			}
		}
	...
	postWinOperation:function (serverSitNum, op, result) {
        ...
        if(this.curGameRoom.playerInfoList[serverSitNum]["sex"] == 1){
            cc.audioEngine.playEffect(voice_root + "male/sound_man_" + voice_list[value] + ".mp3");
        } else {
            cc.audioEngine.playEffect(voice_root + "female/sound_woman_" + voice_list[value] + ".mp3");
        }
