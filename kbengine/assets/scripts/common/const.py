...
# 规则
ROUND_GAME_MODE = 0	# 打局模式
SCORE_GAME_MODE	= 1	# 打片模式
GAME_MODE = (ROUND_GAME_MODE, SCORE_GAME_MODE)
# 局数
GAME_ROUND = (8, 16, 24)
# 封顶
ROUND_MAX_LOSE = (0, 20, 40, 80)
# 带入
GAME_MAX_LOSE = (40, 50, 60)
# 底分
BASE_SCORE = (1, 2, 3)
# 财神
KING_MODE = (0, 1)
# 老庄
BEGIN_DEALER_MUL = (1, 2, 3)
# 胡法
WIN_MODE = (0, 1)
# 三摊承包
THREE_JOB = (0, 1)
